...
network --bootproto=static --device=eth1 --ip=10.100.0.1 --netmask=255.255.255.0
network --bootproto=none --device=eth2
network --bootproto=none --device=eth3
network  --hostname=director.zokahn.local
